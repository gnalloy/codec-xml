# ADR-001: Keep codec-xml as an Independent Gnalloy Module
...
`codec-xml` is published as `gnalloy.org/codec-xml` and owns this responsibility: Streaming XML token codecs for Gnalloy ByteBuf and pipeline integration.
